 ...
 * 
 */
	class WPTableGateway{
		
		protected $table_name;
		
		public function WPTableGateway($table_name){
		...
		protected function _get_items_by_field(  $field, $id ){
		...
		public function get_by($field, $id){

			return $this->_get_items_by_field($field, $id);

		}
		
		protected function _update_item($id, $field, $value, $type){
		...
		public function update($id, $field, $value, $type ='%s'){
			...
			return $this->_update_item($id, $field, $value, $type);
